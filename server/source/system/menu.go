...
func (m *menu) Initialize() error {
	entities := []system.SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "https://www.Doraemon.com", Name: "https://www.Doraemon.com", Component: "/", Sort: 0, Meta: system.Meta{Title: "官方网站", Icon: "home-filled"}},
